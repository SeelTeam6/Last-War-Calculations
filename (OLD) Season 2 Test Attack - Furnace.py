...
# Inputs go here!
# Do you have the season pass? True/False
season_pass = True

# What is your current furnace level?
current_furnace_level = 19
...
def calc(base_level, damage, total_health):
    while damage < total_health:
        ...
        current_damage_proportion = damage_actual * (100 / enemy_increase)
        ...
        next_damage_proportion = damage_actual * (100 / enemy_increase)
...
needed_level, needed_res = calc(current_furnace_level, damage, total_health)
